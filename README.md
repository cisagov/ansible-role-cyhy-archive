...
[![License](https://img.shields.io/github/license/cisagov/ansible-role-cyhy-archive)](https://spdx.org/licenses/)
...
secrets on the
[appropriate page](https://github.com/cisagov/ansible-role-cyhy-archive/settings/secrets)
...
|----------|-------------|---------|----------|
| cyhy\_archive\_cyhy\_core\_version | The version of cisagov/cyhy-core to use; must be a valid git reference. | `v1.1.2` | No |
